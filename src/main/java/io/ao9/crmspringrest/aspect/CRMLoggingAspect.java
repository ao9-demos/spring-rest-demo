package io.ao9.crmspringrest.aspect;
...
public class CRMLoggingAspect {
    ...
    @Pointcut("execution(* io.ao9.crmspringrest.controller.*.*(..))")
    private void forControllerPackage() {        
    }

    @Pointcut("execution(* io.ao9.crmspringrest.service.*.*(..))")
    private void forServicePackage() {        
    }

    @Pointcut("execution(* io.ao9.crmspringrest.dao.*.*(..))")
